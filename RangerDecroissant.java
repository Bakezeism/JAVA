...
class RangerDecroissant {
    public static void main(String[] args) {
        ...
        if ((nombre1 >= nombre2) && (nombre2 >= nombre3)){
            System.out.println("Les numéros triés par ordre decroissants est :  " + nombre1 + " " + nombre2 + " " + nombre3);
            }
        if ((nombre1 >= nombre2) && (nombre2 <= nombre3)){
            System.out.println("Les numéros triés par ordre decroissants est : " + nombre1 + " " + nombre2 + " " + nombre3);
            }
        ...
        if ((nombre1 <= nombre2) && (nombre2 >= nombre3)){
            System.out.println("Les numéros triés par ordre decroissants est :  " + nombre2 + " " + nombre1 + " " + nombre3);
            }
